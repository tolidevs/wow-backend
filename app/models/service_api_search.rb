...
class ServiceApiSearch
    ...
    def create_url_string
        @url="https://utelly-tv-shows-and-movies-availability-v1.p.rapidapi.com/idlookup?country=UK&source_id=#{@id}&source=imdb"
    end
    ...
    def create_service_objects
        services = get_shows["collection"]["locations"]
        objects_array = api_response.map { |service| 
